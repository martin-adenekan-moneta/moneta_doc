...
With dynamic splits, you can create split for a payment during transaction initialization. This can be achieved by passing a `split` object to the transaction initialize endpoint.
...
```bash
{
    ...
    "amount": "225000", 
    "email": "", #optional- merchant email
    "payment_type": "card",
    "channel":"card", #optional - channel of payment
    "customerinfo": { # optional customer information
        "first_name": "Test",
        "last_name": "Example"
    },
    "hash": "{{transaction_hash}}",  # base64 transaction hash generated by your code
    ...
    "split": {
        ...
        "subaccounts": [
            {
                "subaccount": "09005960456",
                "bank_code": 14,
                "share": 205000,
                "fee_bearer": true
            },
            {
                "subaccount": "0934983806",
                "bank_code": 14,
                "share": 200000
            }
        ]
...
```bash
{
    ...
    "ref_no": "24898990643",
    "type": "card",
    "authorization_url": "/api/v2/staging/txn/isw/24898990643",
    "split_breakdown": {
        "id": 6,
        "user_id": 1,
        "alias": "Dynamic Split",
        "aggregator": 1,
        "split_code": "DYN_6a9059109f323",
        "subaccounts": "09005960456,0934983806",
        "banks": "000003,000003",
        "shares": "205000,200000",
        "bearer": "09005960456",
        "perc_flat": "flat",
        "base_amount": null,
        "gateway": "bank",
        "split_group": "DYN_6a9059109f323",
        "Status": 1,
        "is_dynamic": 1,
        "is_default": 0,
        "created_at": "2026-08-27T15:34:40.000000Z",
        "updated_at": "2026-08-27T15:34:40.000000Z"
    }
}
```
{% endtab %}
